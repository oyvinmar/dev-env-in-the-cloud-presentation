...
<h1 style={{
display: 'flex',
fontFamily: '"Gotham Rounded A","Gotham Rounded B","Helvetica Neue",Arial,sans-serif',
}}>

  <img src="/public/nuclide_logo.png" style={{ height: '120px' }} /><span style={{marginLeft: '32px'}}>Nuclide</span>
</h1>
